...
class Boid extends Particle {
  ...
  public static final float MAX_FORCE = 0.35f;

  public static final float DESIRED_SEPARATION = 150.0f;
  public static final float MAX_NEIGHBOR_DISTANCE = 175.0f;

  public static final float DEAD_DISTANCE = 4.0f;
  public static final int MAX_TRAIL_LENGTH = 1;
